...
namespace KatlaSport.Services.HiveManagement
{
    ...
    public interface IHiveSectionService
    {
        ...
        /// </summary>
        /// <param name="createHiveSectionRequest">The create hive section request.</param>
        /// <returns>A <see cref="Task{HiveSection}"/>.</returns>
        Task<HiveSection> CreateHiveSectionAsync(UpdateHiveSectionRequest createHiveSectionRequest);
